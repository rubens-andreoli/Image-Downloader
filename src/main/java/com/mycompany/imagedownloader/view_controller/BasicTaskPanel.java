...
public abstract class BasicTaskPanel extends TaskPanel { //TODO: just destination field
    private static final long serialVersionUID = 1L;

    public BasicTaskPanel(String title, int defaultValue) {
        super(title);
        initComponents();
        txfNumber.setText(String.valueOf(defaultValue));
    }
    ...
    public abstract Task createTask(String url, String dest, int val);
